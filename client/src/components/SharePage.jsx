...
import { Download, Loader2, Image, Package, Smile, Check } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-500 to-primary-700 text-white">
        <div className="max-w-3xl mx-auto px-4 py-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-primary-200">表情包搬家助手</span>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 mb-6">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="flex-1 text-center sm:text-left">
                <h2 className="font-bold text-gray-800 text-lg mb-1">一键批量下载</h2>
                <p className="text-gray-500 text-sm">
                  下载全部 {collection.emojis.length} 个表情包（ZIP压缩包），解压后导入到你喜欢的平台
                </p>
              </div>
              <a
                href={getDownloadUrl(id)}
                className="flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-green-700 transition-colors whitespace-nowrap"
              >
        ...
        {collection.emojis.length > 0 ? (
          <div>
            <h2 className="font-bold text-gray-800 mb-4">全部表情包</h2>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-100 p-6">
          <h2 className="font-bold text-gray-800 mb-4">📲 下载后如何导入？</h2>
